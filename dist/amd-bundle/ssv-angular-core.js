...
(function() {
var _removeDefine = $__System.get("@@amd-helpers").createDefine();
define("4", ["require", "exports", "2", "3"], function(require, exports, logger_model_1, logger_service_1) {
  function __export(m) {
    for (var p in m)
...
(function() {
var _removeDefine = $__System.get("@@amd-helpers").createDefine();
define("5", ["require", "exports"], function(require, exports) {
  var Consts = (function() {
    function Consts() {
      this.moduleName = "ssv-angular-core";
    }
    return Consts;
  })();
  exports.Consts = Consts;
  exports.consts = new Consts();
});
...
(function() {
var _removeDefine = $__System.get("@@amd-helpers").createDefine();
define("6", ["require", "exports", "7", "4", "5"], function(require, exports, angular, logger_1, core_consts_1) {
  ...
  globalModule.service(logger_1.LoggerService.id, logger_1.LoggerService).factory("loggerFactory", logger_1.loggerFactory);
...
(function() {
var _removeDefine = $__System.get("@@amd-helpers").createDefine();
define("1", ["require", "exports", "4", "6", "5"], function(require, exports, logger_1, core_module_1, core_consts_1) {
  function __export(m) {
    for (var p in m)
      if (!exports.hasOwnProperty(p))
        exports[p] = m[p];
